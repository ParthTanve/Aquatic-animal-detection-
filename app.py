...
import os
import datetime
import random # Added for dynamic simulation
import pyrebase  # Firebase integration (System Authorization)
import base64  # 🟢 ADDED: Local video read karne ke liye
...
<style>
    ...
    .guide-card {
        ...
        border: 2px solid #D000FF; border-radius: 15px; padding: 20px; text-align: center; margin: 0 auto 30px auto; width: 60%; box-shadow: 0px 0px 25px rgba(208, 0, 255, 0.4); backdrop-filter: blur(10px); transition: transform 0.4s ease, box-shadow 0.4s ease;
    }
    ...
    .team-card {
        background: rgba(10, 15, 30, 0.6); border-top: 3px solid #00C9FF; border-bottom: 3px solid #92FE9D; border-radius: 12px; padding: 20px 10px; width: 18%; min-width: 160px; text-align: center; backdrop-filter: blur(10px); transition: all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275); box-shadow: 0px 8px 20px rgba(0,0,0,0.6);
    }
...
if st.session_state.current_page == "login":
    render_auth_background_video() # 🟢 INJECTED VIDEO HERE
